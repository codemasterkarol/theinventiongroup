...
<div class="small-12 columns">
    ...
    <p>When you request an invention report, we collect the personal information you give us such as your name, and email address.</p>
    ...
    <p>Email marketing (if applicable): With your permission, we may send you emails about our site, new products and other updates.</p>
    ...
    <p>When you provide us with personal information to request an invention report, we imply that you consent to our collecting it and using it for that specific reason only.</p>
    ...
    <p>If after you opt-in, you change your mind, you may withdraw your consent for us to contact you, for the continued collection, use or disclosure of your information, at anytime, by contacting us at kclouse1@my.wctc.edu or mailing us at: The Invention Group 800 Main Street, Pewaukee, WI, 53072, United States</p>
    ...
    <ul>
        <li>_session_id, unique token, sessional, Allows us to store information about your session (referrer, landing page, etc).</li>
    ...
    <p>If you would like to: access, correct, amend or delete any personal information we have about you, register a complaint, or simply want more information contact our Privacy Compliance Officer at kclouse1@my.wctc.edu or by mail at The Invention Group</p>

    <p>[Re: Privacy Compliance Officer]</p>

    <p>[800 Main Street, Pewaukee, WI, 53072, United States]</p>
